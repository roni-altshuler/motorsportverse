...
export default function manifest(): MetadataRoute.Manifest {
  return {
    name: "RaceIQ F1 — Formula 1 predictions",
    short_name: "RaceIQ F1",
    description: "Race, qualifying and championship forecasts for Formula 1, scored against real results.",
    start_url: ".",
    display: "browser",
