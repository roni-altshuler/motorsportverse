 ...
 * position + finish status come from the race-result rows (or the compact
 * `actualResults`/`actualStatus` fallback) — all distilled upstream into
 * `DriverRoundResult`. Only rounds with an official result are shown. Each row
 * links through to the full race page.
 */
      ...
      <table className="w-full text-sm border-collapse">
        <thead>
          <tr className="text-left">
            {["Round", "Grand Prix", "Pred.", "Actual", "Δ", "Status", "Pts"].map(
              (h, i) => (
                <th
                  key={h}
            ...
            return (
              ...
              >
                ...
                <td className="py-2.5">
                  ...
                  >
                    <CountryFlag country={r.gpKey} size={20} />
