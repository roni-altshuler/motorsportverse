 ...
 * driven by motogp.json. Override the site URL with NEXT_PUBLIC_SITE_URL.
 */
...
const SITE_URL =
  ...
  "https://motorsportverse.org/projects/motogp-predictions";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  try {
    ...
    /* fall back to defaults if motogp.json is unreadable at build time */
  }
