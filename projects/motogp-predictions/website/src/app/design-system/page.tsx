 ...
 *
 * Living style guide (ported from the RaceIQ F1 flagship, themed MotoGP
...
export const metadata: Metadata = {
  title: "Design System · RaceIQ MotoGP",
    ...
    <div className="mx-auto max-w-6xl px-4 py-10 space-y-8">
      ...
      <header className="space-y-3">
        ...
        <h1 className="text-3xl font-extrabold leading-tight tracking-tight">
          RaceIQ MotoGP · Design System
        </h1>
        <p className="text-[color:var(--text-secondary)] max-w-2xl">
          The RaceIQ design system, themed in MotoGP championship gold. Every surface, accent,
      ...
      <section className={SECTION_CLS}>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
          ...
          <TokenSwatch label="Accent" cssVar="--accent" value="championship gold" />
      ...
      <section className={SECTION_CLS}>
        ...
        <div className="space-y-3">
          ...
          <div className="font-sans text-xl font-semibold text-[color:var(--text-secondary)]">
            Sprint + Grand Prix · shared qualifying grid
          </div>
      ...
      <section className={SECTION_CLS}>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Badge variant="muted">Grand Prix</Badge>
      ...
      <section className={SECTION_CLS}>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          <Stat label="P(win)" value="34%" hint="Grand Prix leader" tone="live" />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardTitle>MotoGP · Round 6</CardTitle>
              <CardDescription>Sprint + Grand Prix · forecast updated recently</CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              ...
              <p className="text-sm text-[color:var(--text-secondary)]">
                ...
                meaningful upside into the Grand Prix.
              </p>
            </CardContent>
