// Circuit outline geometry — the F1 fastest-lap telemetry path, reused for MotoGP
// (MotoGP races the same circuits). Shipped in public/data/circuits.json, keyed by
