import type { CalibrationSummary } from "@/types/motogp";
...
/**
 * Renders calibration_summary.json — the honest calibration status the MotoGP model
 * earned once real rounds were backfilled. Adapts the F1 flagship's calibration
 * panel to MotoGP's shape: applied flag, training-round count, and the per-market
    ...
    <section className="mt-12">
      ...
      <div className="rounded-[var(--radius-lg)] border border-[var(--hairline)] bg-[var(--surface)] p-6">
        <p className="text-sm text-[var(--ink-muted)]">
          ...
          actually happen. MotoGP&rsquo;s forecasts are tuned against the real classified
        ...
        <p className="mt-3 text-xs text-[var(--ink-dim)]">
          Each figure is how many prior rider-outcomes fed the calibrator for that
