 ...
 *
 * MotoGP runs two scored races per round, so each round contributes up to two rows
 ...
 * RaceIQ F1 flagship and adapted to MotoGP's dual-race weekend.
 */
                ...
                <td className="py-2.5">
                  ...
                  >
                    ...
                    <Badge variant={r.raceType === "feature" ? "live" : "default"}>
                      {r.raceType === "feature" ? "Grand Prix" : "Sprint"}
                    </Badge>
                  </Link>
                </td>
