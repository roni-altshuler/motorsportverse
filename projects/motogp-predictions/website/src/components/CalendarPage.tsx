...
/**
 * Faithful MotoGP port of the RaceIQ F1 CalendarPage: a SeasonRibbon strip, a
 * photographic race-card grid (aerial circuit art via getRaceArt), a 3-up
 * season-stats row, and a hairline-divided round list. Adapted to the MotoGP
 * CalendarRound shape — each round is a Saturday sprint plus a Sunday Grand
 * Prix at the same circuit (they share the qualifying grid, no reverse grid).
 *
 ...
 * motogp.json overlays the baked props client-side (mirrors F1's useSeason wiring).
 */
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-bugatti">
      <div className="mb-12 max-w-3xl">
        <p className="eyebrow mb-4">MotoGP · {season} World Championship</p>
        ...
        <p className="body-md text-[color:var(--body)] mb-2">
          ...
          result after. Each round runs a Saturday sprint and a Sunday Grand Prix.
        </p>
