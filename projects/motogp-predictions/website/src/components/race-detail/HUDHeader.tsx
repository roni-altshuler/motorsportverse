...
/**
 * Telemetry-framed race header — the MotoGP analogue of the F1 flagship's
 * HUDHeader, adapted to MotoGP's data reality. MotoGP ships no per-round weather, so
 * the right-hand weather strip is replaced by a dual-race indicator (every MotoGP
 * round scores both a Sprint and a Grand Prix).
 */
      ...
      <HUDPanel
        ...
        rightSlot={
          <div className="flex flex-wrap items-center justify-end gap-2">
            <Badge variant="info">Sprint + Grand Prix</Badge>
