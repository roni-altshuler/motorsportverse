...
// the shared design tokens like the rest of the MotoGP chart family.
//
  ...
  return (
    <div>
      ...
      <svg
        ...
        role="img"
        aria-label="Slope chart connecting each rider's predicted finishing position to their actual result"
      >
        {/* Column headers */}
        <text
          x={xLeft - 8}
      ...
      <p className="mt-3 text-xs text-[var(--ink-dim)]">
        ...
        within three places. ·NC marks riders not classified in the race.
      </p>
    </div>
  );
}
