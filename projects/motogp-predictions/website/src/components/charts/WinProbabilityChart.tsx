...
/**
 * Win-market-by-round chart — the MotoGP adaptation of the F1 flagship's
 * WinProbabilityChart, reshaped around the data MotoGP actually has.
 *
 * F1 charts a single round's win market as bars (it has per-round quali-time
 * ensembles). MotoGP's probability layer re-forecasts every round leakage-safely,
