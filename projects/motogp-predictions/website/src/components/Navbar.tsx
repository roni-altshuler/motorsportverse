...
import { getRoundLifecycle, getRoundStatusMeta, useSeasonMotogpData } from "@/lib/motogpClient";
 ...
 * MotoGP data contract (motogp.json). Hover-opening Races dropdown with a ~140ms grace
 * timeout, Standings dropdown (riders / manufacturers / who-can-win) with computed
...
export default function Navbar() {
  ...
  const { data, isArchived } = useSeasonMotogpData();
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-14 gap-2 sm:gap-4">
          ...
          {/* wordmark — RaceIQ MotoGP brand lockup (sliced from the master brand board) */}
          <Link href="/" className="flex items-center group shrink-0" aria-label="RaceIQ MotoGP home">
            <img
                ...
                {standingsOpen && (
                  ...
                  >
                    <div className="grid grid-cols-3 gap-2">
                      {[
                        { href: "/standings?tab=drivers", label: "Riders", hint: "Per-rider totals" },
