 ...
 *
 * - One season available → a static "MotoGP <year>" chip (no interaction).
 ...
 * MotoGP's championship gold in tokens.css — do not "fix" the variable name.
 */
