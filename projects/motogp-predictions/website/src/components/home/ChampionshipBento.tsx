...
/**
 * Bento mosaic snapshot of the MotoGP championship state. Ported from RaceIQ F1's
 * ChampionshipBento. MotoGP carries no per-round dates (so the countdown becomes
 * the next-round name) and no sprint flag (so the "sprints remaining" tile
 * becomes a title-odds tile sourced from the driver championship odds). The
 * accuracy tile uses the season podium hit-rate, since MotoGP has no single
 * headline accuracy percentage like F1.
 */
        ...
        <div className="flex h-full flex-col p-6">
          <div className="flex items-baseline justify-between mb-4">
            <div>
              ...
              <h3 className="title-md text-[color:var(--ink)]">Riders · Top 5</h3>
            </div>
            <Link
