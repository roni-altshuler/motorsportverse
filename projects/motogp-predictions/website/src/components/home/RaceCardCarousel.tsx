 ...
 * MotoGP shares the F1 weekends and circuits, so `getRaceArt(round.key)` resolves
 * an aerial photo for all 13 rounds. The MotoGP export carries no per-round dates
