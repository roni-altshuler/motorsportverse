 ...
 * reframed for MotoGP's manufacturer world championship — the marques behind the
 * grid (Ducati, Aprilia, KTM, Yamaha, Honda). Each gets a circular badge
 * orbiting at one of two radii
 * (split across two rings to avoid collisions); container is responsive so badges
 * never spill the viewport on narrow screens. Themed to MotoGP championship gold.
 *
