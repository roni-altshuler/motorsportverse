...
/**
 * Hero band for RaceIQ MotoGP. Ported from the F1 HeroParallax. MotoGP ships the same
 * fastest-lap circuit geometry as F1 (public/data/circuits.json), so this
 * variant restores the animated track-ribbon sweep — tinted to MotoGP championship
 * blue — behind the radial-gradient backdrop and dot-pattern substrate. The
 * global `prefers-reduced-motion` guard in globals.css neutralises the motion.
 */
