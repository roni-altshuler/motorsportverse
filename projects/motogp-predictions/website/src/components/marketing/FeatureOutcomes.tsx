 ...
 * real product surface. Ported from RaceIQ F1 and reworded for MotoGP: two races
...
const OUTCOMES: Outcome[] = [
  {
    ...
    description:
      "Win, podium, top-six and top-ten probabilities for every rider, across the Saturday sprint and the Sunday Grand Prix.",
    href: "/predictions",
  ...
  },
  {
    ...
    description:
      "Rider and manufacturer standings with a projected final-points range and who can still mathematically win the crown.",
    href: "/standings",
    cta: "View standings",
    span: "md:col-span-1",
  },
  ...
  },
  {
    ...
    description:
      "All 22 rounds at a glance with live status, then a sprint-plus-Grand-Prix deep dive per round.",
    href: "/calendar",
