 ...
 * backtest block. MotoGP has no backtest export yet, so the figures here are
...
export default function TrustBand({
  ...
  const provenanceChips = [
    "MotoGP results",
    "Rider-form model · Sprint + Grand Prix",
    "Two races per round · Sprint + Grand Prix",
    ...
    >
      ...
      >
        ...
        >
          ...
          chequered flag drops on both races of the round — sprint and Grand Prix —
