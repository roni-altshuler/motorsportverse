 ...
 * RaceIQ F1. MotoGP has no telemetry, weather or pit-strategy data, so the copy is
 * reworded around what MotoGP actually provides: per-round results across both
 * races, a rider-form model, and per-race probabilities. Two
...
const STEPS: Step[] = [
  {
    Icon: Database,
    title: "MotoGP results",
    copy: "Sprint and Grand Prix finishing orders, grids and championship standings ingested after every round.",
  },
  {
    Icon: Cpu,
    title: "The model",
    copy: "A rider-form model — qualifying position, recent form and head-to-head history carry the signal. It re-trains as the season unfolds, then weighs every rider in the field.",
  },
  {
    Icon: Trophy,
    title: "Race forecast",
    copy: "Probabilities for win, podium, top six and top ten — for both the Saturday sprint and the Sunday Grand Prix.",
  },
];
