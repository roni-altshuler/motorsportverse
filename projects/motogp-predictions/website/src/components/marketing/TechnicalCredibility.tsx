 ...
 * MotoGP: reliability, freshness, reproducibility, openness, and the shared
 * MotorsportVerse core. Freshness comes in as a build-time prop; MotoGP has no
  ...
  const pillars: Pillar[] = [
    {
      ...
      body: "An automated pipeline folds in the latest sprint and Grand Prix result before the next round — recent form and grid position, no manual intervention.",
    },
    {
      Icon: Clock,
    ...
    },
    {
      ...
      body: roundsGraded
        ? `Built on the same motorsport-core that powers RaceIQ F1, with ${roundsGraded} MotoGP ${roundsGraded === 1 ? "round" : "rounds"} graded so far this season.`
        : "Built on the same motorsport-core that powers RaceIQ F1 — one engine, tuned for MotoGP's rider- and manufacturer-title fights.",
    },
  ];
