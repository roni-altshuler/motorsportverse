"""Static configuration for MotoGP.
...
CLASSES: tuple[str, ...] = ("MotoGP", "Moto2", "Moto3",)

#: Where results would come from once a source is implemented.
SOURCE_NAME = "the official MotoGP results pages"
SOURCE_URL = "https://www.motogp.com/en/gp-results"
