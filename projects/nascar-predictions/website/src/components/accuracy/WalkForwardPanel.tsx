import type { ForwardEvalSeason, WalkForwardBlock } from "@/types/nascar";
...
const RACE_LABELS: Record<string, string> = { race: "Cup Race" };
...
/**
 * Walk-forward headline: is the NASCAR model actually beating the trivial
