import type { CalibrationSummary } from "@/types/nascar";
...
/**
 * Renders calibration_summary.json — the honest calibration status the NASCAR
 * model earned on real rounds. Adapts the F1 flagship's calibration panel to
 * the Cup shape: applied flag, training-round count, the four track-type strata
