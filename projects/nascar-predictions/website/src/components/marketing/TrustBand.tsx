 ...
 * backtest block. NASCAR's figures here are derived at build time from the live
...
export default function TrustBand({
  ...
  const provenanceChips = [
    "Official NASCAR Cup results",
    "Track-type-aware forecasts · 4 archetypes",
    "Stage points + DNF hazard modelled",
