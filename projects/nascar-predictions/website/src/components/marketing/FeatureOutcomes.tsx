 ...
 * real product surface. Ported from RaceIQ F1 and reworded for NASCAR: one
 * points race per round, win/podium/top-six/top-ten probabilities plus a DNF
 * hazard, a Chase playoff projection, and honest per-round grading. Whole
...
const OUTCOMES: Outcome[] = [
  {
    ...
    description:
      "Win, podium, top-six and top-ten probabilities for every car in the field — with a retirement risk on each — tuned per track type, from Talladega to Sonoma.",
    href: "/predictions",
  ...
  {
    Icon: TrendingUp,
    name: "Track the road to the Chase",
    description:
      "Drivers, teams and manufacturers, the playoff cut line as it stands today, and every driver's odds of making the sixteen and winning the title.",
    href: "/standings",
    cta: "View standings",
    span: "md:col-span-1",
  },
  {
    ...
    description:
      "Post-round grading for every Cup race — no forecast disappears once the result is in.",
    href: "/accuracy",
  ...
  },
  {
    ...
    description:
      "All thirty-six rounds at a glance — superspeedways, intermediates, short tracks and road courses badged, playoff rounds marked, then a deep dive per round.",
    href: "/calendar",
