...
import { getRoundLifecycle, getRoundStatusMeta, useSeasonNascarData } from "@/lib/nascarclient";
 ...
 * NASCAR data contract (nascar.json). Hover-opening Races dropdown with a ~140ms grace
...
export default function Navbar() {
  ...
  const { data, isArchived } = useSeasonNascarData();
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-14 gap-2 sm:gap-4">
          ...
          {/* wordmark — RaceIQ NASCAR brand lockup (shared RaceIQ logo system) */}
          <Link href="/" className="flex items-center group shrink-0" aria-label="RaceIQ NASCAR home">
            <img
