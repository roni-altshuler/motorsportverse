...
/**
 * NASCAR port of the RaceIQ F1 CalendarPage: a SeasonRibbon strip, a
 * photographic race-card grid (aerial track art via getRaceArt), a 3-up
 * season-stats row, and a hairline-divided round list. Adapted to the Cup
 * calendar's reality: one points race per round across 36 rounds, a four-way
 * track-type badge on every round (superspeedway / intermediate / short track
 * / road course), and a playoff marker on the ten Chase rounds.
 *
 ...
 * nascar.json overlays the baked props client-side (mirrors F1's useSeason wiring).
 */
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-bugatti">
      <div className="mb-12 max-w-3xl">
        <p className="eyebrow mb-4">NASCAR Cup Series · Season {season}</p>
        <h1 className="display-xl [font-weight:700] mb-4">Season Calendar</h1>
        <p className="body-md text-[color:var(--body)] mb-2">
          Every Cup race of the {season} season — a forecast before each race, the
          official result after. Twenty-six regular-season rounds set the playoff
          field{playoffStart ? `, then the Chase runs from Round ${playoffStart}` : ""}.
        </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-0 mb-16 mt-12 hairline-divider-top">
        ...
        <div className="row-spec sm:border-b-0 sm:px-8 sm:border-r border-[color:var(--hairline)]">
          ...
          <p className="body-sm text-[color:var(--muted)] mt-3">
            Still to run before the title is settled at Homestead.
          </p>
        </div>
              ...
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-3 flex-wrap mb-1">
                    ...
                    {r.isPlayoff && <Badge variant="live">Playoffs</Badge>}
                    {r.completed ? (
