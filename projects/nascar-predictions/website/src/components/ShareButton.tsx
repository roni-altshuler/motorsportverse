...
/**
 * ShareButton — lightweight share cluster for a page header.
 *
 ...
 *
 * The button only needs to hand over the page URL (read lazily from
...
export default function ShareButton({ title, text, className }: ShareButtonProps) {
  ...
  const shareText = text ?? `${title} — NASCAR race prediction & win-probability model`;
