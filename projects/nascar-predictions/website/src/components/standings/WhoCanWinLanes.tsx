...
import type { TitleOdds } from "@/types/nascar";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-baseline justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="body-md text-[color:var(--text-muted)] max-w-2xl">
            ...
            remaining round{remainingRounds === 1 ? "" : "s"}, Chase format included.
            Updated after the latest round.
          </p>
        </div>
      </div>
      ...
      <p className="text-xs text-[color:var(--text-muted)]">
        Title odds run through the full Chase format — regular season, playoff
        qualification and the ten playoff races. Projected points cover the
        regular season only (the playoffs reset the field), and account for
        stage points and retirement risk.
      </p>
    </div>
  );
}
