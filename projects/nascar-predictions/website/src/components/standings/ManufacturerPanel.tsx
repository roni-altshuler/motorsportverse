...
/**
 * Manufacturer standings — NASCAR-specific strip. Three makes (Chevrolet /
 * Ford / Toyota) race for the manufacturers' championship; the export ships
 * points + wins + a brand accent per make in `manufacturerStandings`.
 */
import { NumberTicker } from "@/components/magicui/number-ticker";
import type { ManufacturerStanding } from "@/types/nascar";
...
export default function ManufacturerPanel({
  ...
  return (
    <div className="space-y-3">
      <h3 className="section-heading">Manufacturers&rsquo; Championship</h3>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        {manufacturers.map((m) => (
          <div key={m.make} className="card relative overflow-hidden p-5">
            <div
            ...
            <h4 className="title-md mb-1 text-[color:var(--ink)]">{m.make}</h4>
