...
/**
 * Declarative GSAP + ScrollTrigger wrapper. Dynamic-imports gsap on first call
 * and short-circuits entirely when the user prefers reduced motion. Ported
 * verbatim from RaceIQ F1.
 */
