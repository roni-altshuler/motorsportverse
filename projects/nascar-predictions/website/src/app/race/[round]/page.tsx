...
import { allRoundNumbers, getCircuit, getNascarData, getProbabilities, getRound } from "@/lib/nascardata";
 ...
 */
function buildWinTrend(data: NascarData): WinProbabilityTrend | null {
...
export async function generateMetadata({
  ...
  if (!round) return { title: "Round — RaceIQ NASCAR" };
  return {
    title: `Round ${round.round}: ${round.raceName || round.venueName} — RaceIQ NASCAR`,
    description: `Race and championship forecasts for ${round.raceName || round.venueName} at ${round.venueName}.`,
  };
}
