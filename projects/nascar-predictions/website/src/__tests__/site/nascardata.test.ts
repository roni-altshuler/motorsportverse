/**
 * Site-specific tests for RaceIQ NASCAR's published-data contract.
 *
...
describe("nascar.json", () => {
  const data = readJson<Record<string, unknown>>("nascar.json");
