 ...
 * real product surface. Ported from RaceIQ F1 and reworded for Formula E: one
 * race per round, win/podium/top-six/top-ten probabilities, championship
 * projection with who-can-still-win math, and honest per-round grading. Whole
...
const OUTCOMES: Outcome[] = [
  {
    Icon: Trophy,
    name: "See the podium before the grid forms",
    description:
      "Win, podium, top-six and top-ten probabilities for every car in the field, tuned for street walls and permanent circuits alike.",
    href: "/predictions",
    cta: "Open the next E-Prix",
    span: "md:col-span-2",
  },
  {
    Icon: TrendingUp,
  ...
  },
  {
    ...
    description:
      "Post-round grading for every E-Prix — no forecast disappears once the result is in.",
    href: "/accuracy",
  ...
  {
    Icon: CalendarRange,
    name: "Read every venue on the calendar",
    description:
      "All seventeen rounds at a glance — doubleheaders paired, street and circuit venues badged, then a deep dive per round.",
    href: "/calendar",
