 ...
 * RaceIQ F1. Formula E has no telemetry, weather or energy-trace feeds, so the
 * copy is reworded around what the championship actually provides: per-round
 * race results, a venue-aware driver model, and per-race probabilities. Two
...
const STEPS: Step[] = [
  {
    Icon: Database,
    title: "Formula E results",
    copy: "Race finishing orders, grids and championship standings ingested after every E-Prix — doubleheaders included.",
  },
  {
    Icon: Cpu,
    title: "The model",
    copy: "A venue-aware driver model — street walls and permanent circuits reward different things, and the forecast is tuned separately for each. It re-trains as the season unfolds, then weighs every car in the field.",
  },
  {
    Icon: Trophy,
    title: "Race forecast",
  ...
  return (
    ...
    >
      ...
      <AnimatedBeam
        ...
        toRef={modelRef}
        duration={4}
        gradientStartColor="#1E1AF0"
        gradientStopColor="#7BD2F6"
      />
      <AnimatedBeam
        containerRef={diagramRef}
        fromRef={modelRef}
        ...
        duration={4}
        delay={1}
        gradientStartColor="#7BD2F6"
        gradientStopColor="#8B89FF"
      />
    </div>
  );
}
