 ...
 * backtest block. FE's figures here are derived at build time from the live
...
export default function TrustBand({
  ...
  const provenanceChips = [
    "Official Formula E results",
    "Street + circuit · venue-aware forecasts",
    "Doubleheaders scored as separate rounds",
    ...
    >
      ...
      >
        ...
        >
          ...
          chequered flag drops on each E-Prix — no cherry-picking. The figures
