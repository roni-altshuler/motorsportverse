 ...
 * Formula E: reliability, freshness, reproducibility, openness, and the shared
...
export default function TechnicalCredibility({
  ...
  const pillars: Pillar[] = [
    ...
    },
    {
      ...
      body: roundsGraded
        ? `Built on the same motorsport-core that powers RaceIQ F1, with ${roundsGraded} Formula E ${roundsGraded === 1 ? "round" : "rounds"} graded so far this season.`
