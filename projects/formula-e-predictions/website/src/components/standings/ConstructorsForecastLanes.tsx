...
import type { TeamStanding } from "@/types/fe";
 ...
 *
 * The FE export ships NO team title-odds array, so "who can still win" is
 * DERIVED here from the points standings:
 *
 *   - Per-round ceiling = a 1-2 finish (25 + 18) + pole (3) + fastest lap (1)
 *     = 47 pts/round for a two-car team, the per-round max a team can claw back.
 ...
 * no real team title probability.
 */
const PER_ROUND_CEILING = 25 + 18 + 3 + 1;
