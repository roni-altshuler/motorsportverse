...
import { getRoundLifecycle, getRoundStatusMeta, useSeasonFEData } from "@/lib/feclient";
 ...
 * Formula E data contract (fe.json). Hover-opening Races dropdown with a ~140ms grace
...
export default function Navbar() {
  ...
  const { data, isArchived } = useSeasonFEData();
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-14 gap-2 sm:gap-4">
          ...
          {/* wordmark — RaceIQ Formula E brand lockup (shared RaceIQ logo system) */}
          <Link href="/" className="flex items-center group shrink-0" aria-label="RaceIQ Formula E home">
            <img
