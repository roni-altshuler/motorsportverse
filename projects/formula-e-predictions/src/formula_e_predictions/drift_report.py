"""Model-health / drift report for FE — thin CLI over motorsport_core.drift.

Reads the per-round JSONs that :mod:`formula_e_predictions.export` writes and
...
Run:  python -m formula_e_predictions.drift_report --season 2026
