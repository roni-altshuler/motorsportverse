"""Snapshot IMSA source — real per-class results from the committed snapshots.
...
keyed by ``cls`` (GTP / DPI / LMP2 / LMP3 / GTDPRO / GTD) because IMSA is scored
per class.
"""
