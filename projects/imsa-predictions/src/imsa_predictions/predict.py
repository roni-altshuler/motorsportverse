"""IMSA WeatherTech SportsCar Championship predictor — the shared ``Predictor`` contract.
...
class IMSAPredictor(Predictor):
    ...
    def fit(self, source: IMSADataSource, season: int, upto_round: int) -> None:
    ...
    def predict(self, source: IMSADataSource, season: int, round: int) -> RoundForecast:
