"""Static configuration for IMSA WeatherTech SportsCar Championship.
...
CLASSES: tuple[str, ...] = ("GTP", "LMP2", "GTD PRO", "GTD",)

#: Where results would come from once a source is implemented.
SOURCE_NAME = "the official IMSA results pages"
SOURCE_URL = "https://www.imsa.com/"
