 ...
 *
 * - One season available → a static "IMSA <year>" chip (no interaction).
 ...
 *
 * The accent token names are shared with the suite (--accent-f1-red) but
 * re-pointed to IMSA green in tokens.css — do not "fix" the variable name.
 */
