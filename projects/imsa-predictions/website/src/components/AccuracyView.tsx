...
import type { CalibrationSummary, ClassMeta, SeasonAccuracyStat } from "@/types/imsa";
...
// Tints for classes that appear in the scored history (byClass) but are absent
// from the top-level `classes` metadata — e.g. archived-season DPi / LMP3.
// GTP mirrors the site-level pill override (teal, distinct from the red accent).
