// Screenshot harness for the RaceIQ IMSA website (MotorsportVerse).
...
//
// Default output: /tmp/imsa-shots (kept out of the repo). Mirrors the host
...
const SHOTS = process.argv[2] || "/tmp/imsa-shots";
const PORT = 4332;
...
const ROUTES = [
  ...
  ["round-3", "/round/3/"],
  ["round-5", "/round/5/"],
  ["entry-GTP-31", "/entry/GTP-31/"],
  ["entry-GTD-12", "/entry/GTD-12/"],
  ["accuracy", "/accuracy/"],
  ["about", "/about/"],
];
