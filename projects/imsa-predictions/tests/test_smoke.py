...
def test_imports():
    from imsa_predictions import config  # noqa: F401
    from imsa_predictions.datasource import IMSADataSource  # noqa: F401
    from imsa_predictions.predict import IMSAPredictor  # noqa: F401
    from imsa_predictions.sources import snapshot  # noqa: F401
