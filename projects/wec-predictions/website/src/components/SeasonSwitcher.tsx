 ...
 *
 * - One season available → a static "WEC <year>" chip (no interaction).
 ...
 * re-pointed to WEC green in tokens.css — do not "fix" the variable name.
 */
