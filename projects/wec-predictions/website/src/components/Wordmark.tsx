/**
 * Inline "RaceIQ WEC" wordmark. Rendered as SVG (not an <img>) so the accent
 * always resolves to the live WEC-green token in tokens.css — the chevron mark
 * and the "WEC" line pick up `--accent-f1-red` (re-pointed to green) and its
 * bright small-text variant.
 */
