...
import { getRoundLifecycle, getRoundStatusMeta, useSeasonWecData } from "@/lib/wecClient";
 ...
 * the WEC data contract (wec.json). Hover-opening Rounds dropdown listing the
...
export default function Navbar() {
  ...
  const { data, isArchived } = useSeasonWecData();
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-14 gap-2 sm:gap-4">
          ...
          <Link href="/" className="flex items-center group shrink-0" aria-label="RaceIQ WEC home">
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="flex-1 truncate">
                              {race.name}
                              {race.isLeMans && (
                                <span className="ml-1.5 eyebrow text-[color:var(--accent-podium-1)]">24H</span>
                              )}
                            </span>
