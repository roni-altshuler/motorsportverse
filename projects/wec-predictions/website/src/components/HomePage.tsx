...
import type { CalibrationSummary, WecData } from "@/types/wec";
      ...
      <section className="relative overflow-hidden border-b border-[color:var(--hairline)]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-14 sm:pt-24 sm:pb-20">
          <motion.p {...reveal} className="eyebrow mb-4">
            FIA World Endurance Championship · {data.season}
          </motion.p>
          <motion.h1
            {...reveal}
          ...
          >
            Win and podium forecasts for Hypercar and LMGT3 across the endurance season — from the
            6-hour rounds to the 24 Hours of Le Mans — plus each class&rsquo;s title fight, scored
            honestly against real results after every round.
          </motion.p>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mt-6">
            <Link href="/predictions" className="link-bugatti body-sm">
              Full {nextClass.label} forecast + LMGT3 →
            </Link>
          </div>
        </section>
      )}
