...
export const metadata: Metadata = {
  title: "About — RaceIQ WEC",
  description:
    "What RaceIQ WEC predicts and how to read it — win and podium probabilities, class championships, and honest accuracy for the FIA World Endurance Championship.",
};
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <header className="mb-10">
        ...
        <p className="body-md mt-4 text-[color:var(--body)]">
          RaceIQ WEC forecasts the FIA World Endurance Championship — a win and podium probability for
      ...
      <div className="flex flex-col gap-4">
        ...
        <Card className="p-6">
          ...
          <p className="body-md text-[color:var(--body)]">
            RaceIQ WEC is an independent MotorsportVerse project. It is not affiliated with the FIA,
            the ACO, the WEC or any team, and its forecasts are model estimates — not betting advice.
          </p>
        </Card>
      </div>
    </div>
