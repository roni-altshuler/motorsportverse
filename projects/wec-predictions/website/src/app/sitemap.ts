...
import { allEntryCodes, allRoundNumbers, getWecData } from "@/lib/wecData";

/**
 * sitemap.ts — generates /sitemap.xml at build time (statically exported).
 * Driven by wec.json. Override the site URL with NEXT_PUBLIC_SITE_URL.
 */
...
const SITE_URL =
  ...
  "https://motorsportverse.org/projects/wec-predictions";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  try {
    ...
    /* fall back to defaults if wec.json is unreadable at build time */
  }
