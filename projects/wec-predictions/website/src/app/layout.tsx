...
// The exact RaceIQ F1 type system, so WEC reads as part of one product family:
// display = Saira Condensed (headlines + wordmark), body = EB Garamond (serif),
// labels/buttons/captions = JetBrains Mono. WEC keeps its own endurance-green
// brand identity (--accent:#3DDC97) — only the typefaces are shared.
...
export const metadata: Metadata = {
  title: "RaceIQ WEC — FIA World Endurance Championship predictions",
  description:
    "Race-by-race and championship forecasts for the FIA World Endurance Championship — win and podium probabilities for every car in Hypercar and LMGT3, plus each class's title fight, updated every round. A MotorsportVerse project on motorsport-core.",
  applicationName: "RaceIQ WEC",
  ...
  openGraph: {
    title: "RaceIQ WEC — FIA World Endurance Championship predictions",
    description:
      "Endurance race and championship forecasts across Hypercar and LMGT3 — a MotorsportVerse project.",
    type: "website",
  },
...
// dark-only; the WEC-green bar mirrors the manifest theme_color.
