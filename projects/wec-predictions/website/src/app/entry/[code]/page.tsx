...
import { allEntryCodes, allRoundNumbers, getRound, getWecData } from "@/lib/wecData";
...
export async function generateMetadata({
  ...
  if (!summary) return { title: "Entry — RaceIQ WEC" };
  const s = summary.standing;
  return {
    title: `#${s.number} ${s.team} — RaceIQ WEC`,
    description: `${summary.classLabel} entry #${s.number} ${s.team} (${s.manufacturer}) — season results, championship position, and per-round predicted vs actual finishes in the FIA WEC.`,
  };
}
