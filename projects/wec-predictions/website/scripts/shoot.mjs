// Screenshot harness for the RaceIQ WEC website (MotorsportVerse).
...
//
// Default output: /tmp/wec-shots (kept out of the repo). Mirrors the host
...
const SHOTS = process.argv[2] || "/tmp/wec-shots";
const PORT = 4332;
...
const ROUTES = [
  ...
  ["round-3", "/round/3/"],
  ["round-5", "/round/5/"],
  ["entry-HYP-20", "/entry/HYP-20/"],
  ["entry-GT3-33", "/entry/GT3-33/"],
  ["accuracy", "/accuracy/"],
  ["about", "/about/"],
];
