"""Static configuration for FIA World Rally Championship.
...
CLASSES: tuple[str, ...] = ("Rally1", "Rally2", "Rally3",)

#: Where results would come from once a source is implemented.
SOURCE_NAME = "the official WRC results pages"
SOURCE_URL = "https://www.wrc.com/"
