// Screenshot harness for the RaceIQ WRC website (MotorsportVerse).
...
//
// Default output: /tmp/wrc-shots (kept out of the repo). Mirrors the host
...
const SHOTS = process.argv[2] || "/tmp/wrc-shots";
const PORT = 4331;
