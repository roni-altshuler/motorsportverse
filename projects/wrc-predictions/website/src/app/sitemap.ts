 ...
 * convention, statically exported). Driven by wrc.json. Override the site URL
...
const SITE_URL =
  ...
  "https://motorsportverse.org/projects/wrc-predictions";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  try {
    ...
    /* fall back to defaults if wrc.json is unreadable at build time */
  }
