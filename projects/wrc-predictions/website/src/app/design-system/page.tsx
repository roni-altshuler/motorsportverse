 ...
 *
 * Living style guide (ported from the RaceIQ F1 flagship, themed WRC blue).
 * Open this page to verify a token change cascades to every primitive. Not
 * linked from the main navigation — internal QA surface only.
 */
...
export const metadata: Metadata = {
  title: "Design System · RaceIQ WRC",
    ...
    <div className="mx-auto max-w-6xl px-4 py-10 space-y-8">
      ...
      <header className="space-y-3">
        ...
        <h1 className="text-3xl font-extrabold leading-tight tracking-tight">
          RaceIQ WRC · Design System
        </h1>
        <p className="text-[color:var(--text-secondary)] max-w-2xl">
          The RaceIQ design system, themed in WRC blue. Every surface, accent,
      ...
      <section className={SECTION_CLS}>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
          ...
          <TokenSwatch label="Accent" cssVar="--accent" value="WRC blue" />
      ...
      <section className={SECTION_CLS}>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Badge variant="info">Gravel</Badge>
          <Badge variant="muted">Tarmac</Badge>
      ...
      <section className={SECTION_CLS}>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          <Stat label="P(win)" value="34%" hint="rally leader" tone="live" />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardTitle>WRC · Round 6</CardTitle>
              <CardDescription>Rally classification · forecast updated recently</CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              ...
              <p className="text-sm text-[color:var(--text-secondary)]">
                ...
                meaningful upside into the rally.
              </p>
            </CardContent>
