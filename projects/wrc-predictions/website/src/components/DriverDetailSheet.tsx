...
/**
 * Crew detail sheet (WRC pop-out).
 *
 * A modal that opens when a classification table row is clicked. It shows the
 * crew's per-rally forecast markets (win / podium / top-6 / top-10), their
...
import type { ClassificationEntry, DriverStanding } from "@/types/wrc";
            ...
            <div>
              ...
              <div style={{ width: "100%", height: 72 }}>
                {chartData.length > 0 ? (
                  ...
                  <p className="body-sm py-4 text-[color:var(--muted)]">No rally results yet.</p>
                )}
              </div>
            </div>
          ) : (
