...
import { fetchWrcData, fetchRoundDetail, fetchRoundProbabilities } from "@/lib/wrcClient";
...
export function RaceDetail({
  ...
  /** The season-calendar entry for this round (date/surface) — powers the .ics
   *  "Add to calendar" button. Baked from the current season. */
  calendarRound?: CalendarRound | null;
}) {
  const reduced = useReducedMotion();
  // Which classification row's detail sheet is open (crew code).
  ...
  return (
    <div>
      ...
      <HUDHeader
        ...
        surfaceColor={round.surfaceColor}
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <ShareButton
          title={`${round.venueName} — WRC round ${round.round}`}
          text={`Rally forecast for the WRC ${round.venueName} round — win and podium probabilities, predicted podium and the model's full classification.`}
        />
      ...
      {/* Auto-generated "what the model sees" bullets for the rally. */}
      <RaceNarrativeCard round={round} championship={championship} />
      ...
      {/* Classification table — every row opens the crew detail sheet. */}
      <Classification
        block={block}
        completed={round.completed}
          ...
          <div className="deep-dive-section-body">
            ...
            >
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <div className="metric-card">
                        <p className="eyebrow mb-1">Crews Forecast</p>
                        <p className="title-md">{block.classification.length}</p>
                      </div>
                      <div className="metric-card">
                        <p className="eyebrow mb-1">Surface</p>
                        <p className="title-md capitalize">{round.surface}</p>
                      </div>
                    </>
                  );
                })()}
              ...
              <p className="body-sm text-[color:var(--muted)]">
                Tap any row in the classification above to open a crew&rsquo;s per-rally
            ...
            >
              ...
              {round.completed && (
                <PredictedVsActualSlope
                  title="Predicted vs actual — rally"
