...
/**
 * Small chip summarising how confident the per-rally forecast is.
 *
 * Wording is intentionally model-agnostic: we say "High Confidence",
 * "Moderate Volatility", or "Chaotic Rally" — never any internal
...
export default function RaceVolatilityBadge({
  ...
  // pill, `live` is the WRC-blue pill; the moderate case re-uses the inline
