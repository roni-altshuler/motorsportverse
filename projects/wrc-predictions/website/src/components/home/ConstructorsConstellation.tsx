...
/**
 * Manufacturer orbital constellation. Ported from RaceIQ F1's constellation and
 * reframed for WRC's manufacturers' world championship — the marques behind the
 * Rally1 field (Toyota, Hyundai, M-Sport Ford). Each gets a circular badge
 * orbiting at one of two radii (split across two rings to avoid collisions);
 * container is responsive so badges never spill the viewport on narrow screens.
 *
...
export default function ConstructorsConstellation({
  ...
  const colorFor = (team: ManufacturerStanding) =>
    team.teamColor || resolveTeamColor(team.team);
