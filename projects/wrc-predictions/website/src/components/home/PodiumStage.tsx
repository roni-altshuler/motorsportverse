...
/**
 * Next-rally predicted podium. Ported from RaceIQ F1's PodiumStage; the WRC
 * export has no predicted stage times or gaps, so the predicted-time / gap rows
 * are dropped and each card shows the model's win probability only. Fed from
 * `nextPrediction.rally.slice(0,3)` with `pWin * 100`.
 */
