 ...
 * primary path into the product (the next rally), one quiet secondary (the
 * receipts). ShimmerButton is the sanctioned glow here; it is reduced-motion
 * guarded globally. Reworded for WRC and routed to /predictions.
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="eyebrow mb-4">Start line</p>
