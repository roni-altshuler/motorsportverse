 ...
 * real product surface. Ported from RaceIQ F1 and reworded for WRC: one
 * classification per rally, win/podium/top-six/top-ten probabilities,
 * championship projection with who-can-still-win math, and honest per-rally
 * grading. Whole card is one keyboard-focusable link with a focus-visible ring.
 */
...
const OUTCOMES: Outcome[] = [
  {
    Icon: Trophy,
    name: "See the podium before the start line",
    description:
      "Win, podium, top-six and top-ten probabilities for every crew, tuned to the rally's surface — gravel, tarmac or snow.",
    href: "/predictions",
    cta: "Open the next rally",
    span: "md:col-span-2",
  },
  {
    Icon: TrendingUp,
    ...
    description:
      "Drivers' and manufacturers' standings with a projected final-points range and who can still mathematically win the crown.",
    href: "/standings",
    cta: "View standings",
    span: "md:col-span-1",
  },
  {
    ...
    description:
      "Post-rally grading for every round — no forecast disappears once the classification is in.",
    href: "/accuracy",
  ...
  {
    Icon: CalendarRange,
    name: "Read every round on the calendar",
    description:
      "Every round at a glance with its surface and live status, then a per-rally deep dive.",
    href: "/calendar",
