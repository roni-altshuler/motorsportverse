...
// Dependency-free podium/win probability board — the WRC analogue of RaceIQ F1's
// visx PodiumProbabilityChart. For each crew, a faded full-width bar shows
// podium probability with a prominent inset bar for win probability, so the two
// markets read in one glance. Drawn with shared tokens + manufacturer colours.
//
// Upgraded to F1-chart-family richness where WRC's data allows: a crew avatar
