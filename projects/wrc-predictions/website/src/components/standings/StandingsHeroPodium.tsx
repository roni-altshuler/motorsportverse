...
import type { DriverStanding } from "@/types/wrc";
...
/**
 * Three-card hero row for P1/P2/P3 in the crews tab (port of the RaceIQ F1
 ...
 * centred (P2 left, P1 middle, P3 right). Adapted to the WRC crew standing shape
