...
import type { DriverStanding, SeasonAccuracy, TitleOdds } from "@/types/wrc";
 ...
 * Adapted to WRC: cells are championship leader (with title odds), gap to P2,
 * rounds remaining, field spread, and a forecast-accuracy cell sourced from
 * seasonAccuracy. Tech-stack-scrubbed copy throughout.
 */
