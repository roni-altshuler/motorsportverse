import type { CalibrationSummary } from "@/types/wrc";
...
/**
 * Renders calibration_summary.json — the honest calibration status the WRC model
 * earned once real rounds were backfilled: applied flag, training-round count, and
 * the per-market observation counts the calibrator was fitted on. (The values in
    ...
    <section className="mt-12">
      ...
      <div className="rounded-[var(--radius-lg)] border border-[var(--hairline)] bg-[var(--surface)] p-6">
        <p className="text-sm text-[var(--ink-muted)]">
          ...
          actually happen. WRC&rsquo;s forecasts are tuned against the real classified
          rally results so a stated 30% podium chance means roughly 3-in-10 over the long run.
        </p>
        ...
        <p className="mt-3 text-xs text-[var(--ink-dim)]">
          Each figure is how many prior crew-outcomes fed the calibrator for that
