...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://motorsportverse.org/projects/chrome-valley-racing";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/season`, lastModified, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE}/garage`, lastModified, changeFrequency: "monthly", priority: 0.6 },
  ];
}
