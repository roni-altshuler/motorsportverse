...
import { allRoundNumbers, getCircuit, getIndycarData, getProbabilities, getRound } from "@/lib/indycardata";
 ...
 */
function buildWinTrend(data: IndycarData): WinProbabilityTrend | null {
...
export async function generateMetadata({
  ...
  if (!round) return { title: "Round — RaceIQ Indy" };
  return {
    title: `Round ${round.round}: ${round.raceName || round.venueName} — RaceIQ Indy`,
