 ...
 *
 * Living style guide (ported from the RaceIQ F1 flagship, themed IndyCar
...
export const metadata: Metadata = {
  title: "Design System · RaceIQ Indy",
    ...
    <div className="mx-auto max-w-6xl px-4 py-10 space-y-8">
      ...
      <header className="space-y-3">
        ...
        <h1 className="text-3xl font-extrabold leading-tight tracking-tight">
          RaceIQ Indy · Design System
        </h1>
        <p className="text-[color:var(--text-secondary)] max-w-2xl">
          The RaceIQ design system, themed in IndyCar racing red. Every surface, accent,
      ...
      <section className={SECTION_CLS}>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
          ...
          <TokenSwatch label="Accent" cssVar="--accent" value="IndyCar red" />
          ...
          <Card>
            <CardHeader>
              <Badge variant="live" className="self-start">
                Round 6 · IndyCar Race
              </Badge>
              <CardTitle>IndyCar · Round 6</CardTitle>
