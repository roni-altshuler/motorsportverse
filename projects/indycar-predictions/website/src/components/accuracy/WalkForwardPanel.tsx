import type { ForwardEvalSeason, WalkForwardBlock } from "@/types/indycar";
...
const RACE_LABELS: Record<string, string> = { race: "IndyCar Race" };
...
/**
 * Walk-forward headline: is the IndyCar model actually beating the trivial
    ...
    <section className="mt-12">
      <div className="mb-4">
        ...
        <p className="mt-2 text-sm text-[var(--ink-muted)]">
          ...
          that assumes the grid finishes in order. Yellow marks the best column. Beating
