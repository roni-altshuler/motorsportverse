...
import type { TitleOdds } from "@/types/indycar";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-baseline justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="body-md text-[color:var(--text-muted)] max-w-2xl">
            ...
            remaining round{remainingRounds === 1 ? "" : "s"}. Updated after the latest
            round.
          </p>
        </div>
      </div>
      ...
      <p className="text-xs text-[color:var(--text-muted)]">
        Title odds simulate every remaining round to the season finale, and
        account for surface-specific form (ovals vs road and street courses)
        and retirement risk.
      </p>
    </div>
  );
