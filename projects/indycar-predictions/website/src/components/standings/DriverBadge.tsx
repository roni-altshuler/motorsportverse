...
/** Compact P4–P8 standings card (port of the RaceIQ F1 DriverBadge). */
    ...
    >
      ...
      >
        <div className="flex items-center gap-3 mb-3">
          <span
            className="font-mono tabular-nums text-3xl sm:text-4xl font-black"
        ...
        <Link
          href={`/driver/${driver}`}
          className="text-lg font-black tracking-tight leading-tight text-[color:var(--ink)] hover:text-[color:var(--accent-f1-red-bright)] transition-colors"
        >
