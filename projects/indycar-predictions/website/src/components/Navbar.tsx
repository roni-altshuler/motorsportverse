...
import { getRoundLifecycle, getRoundStatusMeta, useSeasonIndycarData } from "@/lib/indycarclient";
 ...
 * IndyCar data contract (indycar.json). Hover-opening Races dropdown with a ~140ms grace
...
export default function Navbar() {
  ...
  const { data, isArchived } = useSeasonIndycarData();
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-14 gap-2 sm:gap-4">
          ...
          {/* wordmark — RaceIQ Indy brand lockup (shared RaceIQ logo system) */}
          <Link href="/" className="flex items-center group shrink-0" aria-label="RaceIQ Indy home">
            <img
