/**
 * HomePage — RaceIQ Indy home, ported from the NASCAR site (itself a port
 * of the RaceIQ F1 flagship via Formula E).
 *
 * Server component: reads the build-time IndyCar dataset with `getIndycarData()`
 ...
 *
 * Adapted from NASCAR: IndyCar runs ONE points race per round (18 of them)
 * across three track archetypes (oval / road / street), no playoffs — the
 * championship is decided on season-long points, with the Indianapolis 500
 * as the crown jewel.
 */
  ...
  return (
    <div>
      <HeroParallax className="min-h-[78vh] flex items-center" geometry={nextGeometry}>
        <div className="mx-auto w-full max-w-6xl px-6 lg:px-10 py-20">
          ...
          <div className="max-w-3xl">
            <p className="eyebrow mb-5">RaceIQ · NTT IndyCar Series · Season {seasonLabel}</p>
            <h1 className="display-xl [font-weight:700] text-balance">
              American open wheel, forecast.
            </h1>
            ...
            <div className="mt-12 border-t border-[color:var(--hairline)] pt-8">
              ...
              <div className="mb-8">
                ...
                <p className="body-md mt-3 max-w-2xl text-[color:var(--muted)]">
                  {next.venueName} · one points race — a full-field forecast
                  before the green flag, retirement risk included.
                </p>
              </div>
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-10">
        ...
        {/* ── Teams constellation ── IndyCar teams field multi-car garages
            across two engine suppliers, so the teams' title is a real fight. */}
          ...
          >
            <div className="text-center mb-10">
              ...
              <p className="body-md mt-3 max-w-xl mx-auto text-[color:var(--muted)]">
                {data.teamStandings.length} teams contest the {seasonLabel}{" "}
                IndyCar season — every car on the grid, in orbit. Chevrolet and
                Honda split the paddock, so the engine title is a genuine
                two-supplier fight.
              </p>
            </div>
