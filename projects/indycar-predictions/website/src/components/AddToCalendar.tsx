 ...
 * calendar) to download every round. Both are `CalendarRace` objects mapped
 * from the IndyCar calendar entries { round, name, circuit, date, country }.
 *
 * Ported from the RaceIQ F1 flagship, re-branded for IndyCar.
 */
    ...
    <Button
      ...
      aria-label={
        race
          ...
          : "Add the full IndyCar season to your calendar"
      }
    >
      <CalendarIcon />
      {resolvedLabel}
