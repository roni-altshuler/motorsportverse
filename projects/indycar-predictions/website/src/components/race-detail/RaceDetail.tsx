...
import { fetchIndycarData, fetchRoundDetail, fetchRoundProbabilities } from "@/lib/indycarclient";
...
export function RaceDetail({
  ...
  /** Season calendar — used for the Indy 500 marker on the crown-jewel round. */
