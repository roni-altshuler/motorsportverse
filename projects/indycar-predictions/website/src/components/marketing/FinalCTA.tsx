 ...
 * guarded globally. Reworded for IndyCar and routed to /predictions.
 */
    ...
    >
      ...
      >
        ...
        <p className="body-md mt-5 mx-auto max-w-xl text-[color:var(--body)]">
          Open the next IndyCar race forecast, then judge it against the result. That
          is the whole deal.
        </p>
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
          <Link href="/predictions">
            <ShimmerButton
              background="var(--accent-f1-red-hover)"
