 ...
 * backtest block. IndyCar's figures here are derived at build time from the live
 * season accuracy (rounds run, podium / winner hit-rate, mean position error)
 * and passed in as plain props. No testimonials, user counts, or fabricated
 * logos.
 */
...
export default function TrustBand({
  ...
  const provenanceChips = [
    "Hand-verified IndyCar results",
    "Oval + road/street form scored separately",
    "DNF hazard modelled per driver",
    ...
    >
      ...
      >
        ...
        >
          ...
          checkered flag drops on each race — no cherry-picking. The figures
          below cover the season so far.
        </motion.p>
      </motion.div>
