 ...
 * RaceIQ F1. The IndyCar snapshot has no telemetry or weather feeds, so the
 * copy is reworded around what the championship actually provides: per-round
 * race classifications, a surface-aware driver model with a DNF hazard, and
...
const STEPS: Step[] = [
  {
    Icon: Database,
    title: "IndyCar results",
    copy: "Race classifications, grids and championship standings — fifteen seasons of hand-verified history, updated after every checkered flag.",
  },
  {
    Icon: Cpu,
    title: "The model",
    copy: "A surface-aware driver model — every driver carries separate oval and road/street form, because the two reward different things. A per-driver retirement hazard rides along, and it re-trains as the season unfolds.",
  },
  {
    Icon: Trophy,
    title: "Race forecast",
