...
/**
 * Race-weekend live context band — IndyCar port of the F1 flagship's band.
 *
 * Sticky strip just below the navbar that surfaces the next round's context.
 * The IndyCar snapshot has no live-timing or weather feed (data reality), so this
 * is a thinned version: it shows the next upcoming IndyCar race with a countdown,
 * its track type (superspeedway / intermediate / short / road) and a freshness
 * indicator, driven by the client-side indycar.json loader.
 *
...
import { useIndycarData } from "@/lib/indycarclient";
