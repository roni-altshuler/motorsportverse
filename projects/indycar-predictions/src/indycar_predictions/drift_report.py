"""Model-health / drift report for IndyCar — thin CLI over motorsport_core.drift.

Reads the per-round JSONs that :mod:`indycar_predictions.export` writes and
...
output-side rolling Brier trend on the race win market. Same shape as the
family's.

Run:  python -m indycar_predictions.drift_report --season 2026
