"""Model-health / drift report for F2 — thin CLI over motorsport_core.drift.

Reads the per-round JSONs that :mod:`f2_predictions.export` writes and produces
...
Run:  python -m f2_predictions.drift_report --season 2026 [--allow-empty] [--data <dir>]
"""
