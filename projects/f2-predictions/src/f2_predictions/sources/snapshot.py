"""Snapshot F2 source — real results from the committed offline snapshot.

Reads ``data/official_2026.json`` (produced by :mod:`f2_predictions.refresh`
from fiaformula2.com) and serves the **real** classified order for completed
...
# snapshot.py lives in src/f2_predictions/sources/, so the project root (which
