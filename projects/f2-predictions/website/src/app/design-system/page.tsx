 ...
 *
 * Living style guide (ported from the RaceIQ F1 flagship, themed F2
 * electric-blue). Open this page to verify a token change cascades to every
    ...
    <div className="mx-auto max-w-6xl px-4 py-10 space-y-8">
      ...
      <header className="space-y-3">
        ...
        <h1 className="text-3xl font-extrabold leading-tight tracking-tight">
          RaceIQ F2 · Design System
        </h1>
        <p className="text-[color:var(--text-secondary)] max-w-2xl">
          The RaceIQ design system, themed in Formula 2 electric-blue. Every surface, accent,
      ...
      <section className={SECTION_CLS}>
        ...
        <div className="space-y-3">
          ...
          <div className="font-sans text-xl font-semibold text-[color:var(--text-secondary)]">
            Sprint + Feature · reverse-grid drama up front
          </div>
      ...
      <section className={SECTION_CLS}>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          <Stat label="P(win)" value="34%" hint="feature race leader" tone="live" />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardTitle>Formula 2 · Round 6</CardTitle>
              <CardDescription>Sprint + Feature · forecast updated recently</CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              ...
              <p className="text-sm text-[color:var(--text-secondary)]">
                ...
                meaningful upside into the feature race.
              </p>
            </CardContent>
