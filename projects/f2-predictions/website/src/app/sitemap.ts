 ...
 * driven by f2.json. Override the site URL with NEXT_PUBLIC_SITE_URL.
 */
...
const SITE_URL =
  ...
  "https://motorsportverse.org/projects/f2-predictions";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  try {
    ...
    /* fall back to defaults if f2.json is unreadable at build time */
  }
