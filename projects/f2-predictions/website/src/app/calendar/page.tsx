      ...
      <ol className="mt-10 space-y-2">
        {data.calendar.map((r) => (
          <li key={r.round}>
            <Link
              href={`/race/${r.round}`}
              className="flex items-center justify-between rounded-[var(--radius-md)] border border-[var(--hairline)] bg-[var(--surface)] px-5 py-4 transition-colors hover:border-[var(--accent)] hover:bg-[var(--surface-2)]"
            >
