import type { CalibrationSummary } from "@/types/f2";
...
/**
 * Renders calibration_summary.json — the honest calibration status the F2 model
 * earned once real rounds were backfilled. Adapts the F1 flagship's calibration
 * panel to F2's shape: applied flag, training-round count, and the per-market
    ...
    <section className="mt-12">
      ...
      <div className="rounded-[var(--radius-lg)] border border-[var(--hairline)] bg-[var(--surface)] p-6">
        <p className="text-sm text-[var(--ink-muted)]">
          ...
          actually happen. F2&rsquo;s forecasts are tuned against the real classified
