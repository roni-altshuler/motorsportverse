...
import type { ForwardEvalRound, RaceAccuracy } from "@/types/f2";

/**
 * Grid heatmap of per-round prediction accuracy (F2 port of the RaceIQ F1
 ...
 *
 * F2 has no single per-round "accuracyPct" like F1's season tracker, so the
...
// red as a semantic "miss" signal (red is semantic here, not the F2 brand).
