 ...
 * pattern. Ported from RaceIQ F1 and reworded for F2: spec series, two races
 * per round, FIA Formula 2. Answers stay within the tech-stack scrub policy —
...
const FAQS: QA[] = [
  {
    ...
    a: (
      <>
        No. RaceIQ F2 is a personal project published for education and
  ...
  {
    q: "Why is Formula 2 a good fit for a model?",
    a: (
      <>
        F2 is a spec series — every team runs the same chassis, engine and tyres.
  ...
  },
  {
    ...
    a: (
      <>
        ...
        F2 runs on the same MotorsportVerse core that powers RaceIQ F1.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        ...
        standings, ingested after every round of the FIA Formula 2 season.
      </>
    ),
  },
];
