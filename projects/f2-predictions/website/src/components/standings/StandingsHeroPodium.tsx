...
import type { DriverStanding } from "@/types/f2";
 ...
 * centred (P2 left, P1 middle, P3 right). Adapted to the F2 DriverStanding shape
      ...
      <div className="p-5 sm:p-7 flex flex-col items-start gap-4">
        ...
        <div className="flex items-center gap-4 w-full">
          ...
          <div className="min-w-0 flex-1">
            ...
            >
              <p className="display-md [font-weight:700] text-[color:var(--ink)] !text-[34px] !leading-none mt-1 truncate hover:text-[color:var(--accent)]">
                {driver.name}
              </p>
            </Link>
