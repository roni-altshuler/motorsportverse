...
import type { TitleOdds } from "@/types/f2";
 ...
 * Sourced directly from F2's `championship[]` (TitleOdds). Drivers below the
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-xs text-[color:var(--text-muted)]">
        ...
        weekends, applying the F2 points system (feature + reversed-grid sprint) and accounting
        for retirement risk.
      </p>
    </div>
  );
