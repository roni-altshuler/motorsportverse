...
/**
 * Bento mosaic snapshot of the F2 championship state. Ported from RaceIQ F1's
 * ChampionshipBento. F2 carries no per-round dates (so the countdown becomes
 ...
 * accuracy tile uses the season podium hit-rate, since F2 has no single
