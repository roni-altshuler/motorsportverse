...
// Dependency-free podium/win probability board — the F2 analogue of RaceIQ F1's
...
//
// Upgraded to F1-chart-family richness where F2's data allows: driver headshots
