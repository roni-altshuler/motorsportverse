...
/**
 * Win-market-by-round chart — the F2 adaptation of the F1 flagship's
 * WinProbabilityChart, reshaped around the data F2 actually has.
 *
 * F1 charts a single round's win market as bars (it has per-round quali-time
 * ensembles). F2's probability layer re-forecasts every round leakage-safely,
