// Screenshot harness for the RaceIQ F2 website (MotorsportVerse).
...
//
// Default output: /tmp/f2-shots (kept out of the repo). Mirrors the host
...
const SHOTS = process.argv[2] || "/tmp/f2-shots";
const PORT = 4331;
