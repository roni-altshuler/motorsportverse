...
Port of the F1 flagship's position-model capability (commit 189db5b) to F3:
- the head is env-flag gated (``F3_USE_POSITION_HEAD``) and OFF by default —
...
from f3_predictions import config, forward_eval, model, position_head, promotion_decision
...
def data_dir(tmp_path_factory):
    ...
    out = tmp_path_factory.mktemp("f3ab")
