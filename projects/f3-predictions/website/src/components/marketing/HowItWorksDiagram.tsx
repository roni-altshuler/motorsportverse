 ...
 * RaceIQ F1. F3 has no telemetry, weather or pit-strategy data, so the copy is
  ...
  return (
    ...
    >
      ...
      <AnimatedBeam
        ...
        toRef={modelRef}
        duration={4}
        gradientStartColor="#D9A441"
        gradientStopColor="#F2D49B"
      />
      <AnimatedBeam
        containerRef={diagramRef}
        fromRef={modelRef}
