 ...
 * real product surface. Ported from RaceIQ F1 and reworded for F3: two races
 * per round, win/podium/top-six/top-ten probabilities, championship projection
 * with who-can-still-win math, and honest per-round grading. Whole card is one
 * keyboard-focusable link with a focus-visible ring.
 */
...
const OUTCOMES: Outcome[] = [
  {
    Icon: Trophy,
    name: "See the podium for both races — before lights out",
    description:
      "Win, podium, top-six and top-ten probabilities for every car, across the reversed-grid sprint and the merit-grid feature race.",
    href: "/predictions",
    cta: "Open the next round",
    span: "md:col-span-2",
  },
  {
    Icon: TrendingUp,
    ...
    description:
      "Drivers' and teams' standings with a projected final-points range and who can still mathematically win the crown.",
    href: "/standings",
    cta: "View standings",
    span: "md:col-span-1",
  },
  {
    ...
    description:
      "Post-round grading for both races — no forecast disappears once the result is in.",
    href: "/accuracy",
  ...
  },
  {
    ...
    description:
      "All thirteen rounds at a glance with live status, then a sprint-plus-feature deep dive per round.",
    href: "/calendar",
