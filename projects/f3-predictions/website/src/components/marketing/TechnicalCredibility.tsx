 ...
 * F3: reliability, freshness, reproducibility, openness, and the shared
 * MotorsportVerse core. Freshness comes in as a build-time prop; F3 has no
...
export default function TechnicalCredibility({
  ...
  const pillars: Pillar[] = [
    ...
    },
    {
      ...
      body: roundsGraded
        ? `Built on the same motorsport-core that powers RaceIQ F1, with ${roundsGraded} F3 ${roundsGraded === 1 ? "round" : "rounds"} graded so far this season.`
