 ...
 * to F3's championship gold under the F3 tokens), so it reads as part of one
...
export default function ShareButton({ title, text, className }: ShareButtonProps) {
  ...
  const shareText = text ?? `${title} — F3 race prediction & championship model`;
