...
/**
 * Win-market-by-round chart — the F3 adaptation of the F1 flagship's
 * WinProbabilityChart, reshaped around the data F3 actually has.
 *
 * F1 charts a single round's win market as bars (it has per-round quali-time
 * ensembles). F3's probability layer re-forecasts every round leakage-safely,
