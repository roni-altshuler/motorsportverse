...
import type { TitleOdds } from "@/types/f3";
 ...
 * Sourced directly from F3's `championship[]` (TitleOdds). Drivers below the
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-xs text-[color:var(--text-muted)]">
        ...
        weekends, applying the F3 points system (feature + reversed-grid sprint) and accounting
        for retirement risk.
      </p>
    </div>
  );
