...
/**
 * Race-weekend narrative card — F3 adaptation of the F1 flagship's
 ...
 *
 * The rules are rebuilt around the data F3 actually has (there is no weather
...
import type { RoundDetail, TitleOdds } from "@/types/f3";
