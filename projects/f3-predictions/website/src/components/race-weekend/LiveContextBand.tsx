...
/**
 * Race-weekend live context band — F3 port of the RaceIQ F1 flagship's band.
 *
 * Sticky strip just below the navbar that surfaces the next round's context.
 * F3 has no live-timing or weather feed (data reality), so this is a thinned
 * version: it shows the next upcoming round (sprint + feature) with a countdown
 * and a freshness indicator, driven by the client-side f3.json loader.
 *
