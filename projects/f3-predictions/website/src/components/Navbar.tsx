 ...
 * F3 data contract (f3.json). Hover-opening Races dropdown with a ~140ms grace
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-14 gap-2 sm:gap-4">
          ...
          {/* wordmark — RaceIQ F3 brand lockup (sliced from the master brand board) */}
          <Link href="/" className="flex items-center group shrink-0" aria-label="RaceIQ F3 home">
            <img
