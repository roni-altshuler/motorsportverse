...
import type { ForwardEvalRound, RaceAccuracy } from "@/types/f3";

/**
 * Grid heatmap of per-round prediction accuracy (F3 port of the RaceIQ F1
 ...
 *
 * F3 has no single per-round "accuracyPct" like F1's season tracker, so the
...
// red as a semantic "miss" signal (red is semantic here, not the F3 brand).
