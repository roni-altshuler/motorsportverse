...
/**
 * Bento mosaic snapshot of the F3 championship state. Ported from RaceIQ F1's
 * ChampionshipBento. F3 carries no per-round dates (so the countdown becomes
 ...
 * accuracy tile uses the season podium hit-rate, since F3 has no single
