 ...
 * F3 shares the F1 weekends and circuits, so `getRaceArt(round.key)` resolves
 * an aerial photo for all 13 rounds. The F3 export carries no per-round dates
      ...
      >
        {isFeaturedNext ? (
          <NeonGradientCard
            borderSize={2}
            borderRadius={4}
            neonColors={{ firstColor: "#D9A441", secondColor: "#F2D49B" }}
          >
            {inner}
          </NeonGradientCard>
        ) : (
