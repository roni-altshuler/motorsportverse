...
import type { TeamStanding } from "@/types/f3";
 ...
 * but F3 is a spec series with NO official constructors' championship — so the
 * inner label drops the "one championship" framing and reads as "the teams
 * behind the grid". Each team gets a circular badge orbiting at one of two radii
 * (split across two rings to avoid collisions); container is responsive so badges
 * never spill the viewport on narrow screens. Themed to F3 championship gold.
 *
