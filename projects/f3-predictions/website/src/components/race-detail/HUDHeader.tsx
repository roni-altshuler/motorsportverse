...
/**
 * Telemetry-framed race header — the F3 analogue of the F1 flagship's
 * HUDHeader, adapted to F3's data reality. F3 ships no per-round weather, so
 * the right-hand weather strip is replaced by a dual-race indicator (every F3
