...
import { allRoundNumbers, getCircuit, getF3Data, getProbabilities, getRound } from "@/lib/f3data";
 ...
 */
function buildWinTrend(data: F3Data): WinProbabilityTrend | null {
...
export async function generateMetadata({
  ...
  if (!round) return { title: "Round — RaceIQ F3" };
  return {
    title: `Round ${round.round}: ${round.venueName} — RaceIQ F3`,
    description: `Sprint and feature-race forecasts for the F3 ${round.venueName} round.`,
  };
}
