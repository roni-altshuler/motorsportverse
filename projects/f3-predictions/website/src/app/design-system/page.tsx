 ...
 *
 * Living style guide (ported from the RaceIQ F1 flagship, themed F3
    ...
    <div className="mx-auto max-w-6xl px-4 py-10 space-y-8">
      ...
      <header className="space-y-3">
        ...
        <h1 className="text-3xl font-extrabold leading-tight tracking-tight">
          RaceIQ F3 · Design System
        </h1>
        <p className="text-[color:var(--text-secondary)] max-w-2xl">
          The RaceIQ design system, themed in Formula 3 championship gold. Every surface, accent,
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardTitle>Formula 3 · Round 6</CardTitle>
