"""Official FIA F3 timing/results — scrape-shaped, opt-in, best-effort.

The authoritative F3 results live on fiaformula3.com, but there is no stable
...
URL template is configured via ``config.OFFICIAL_F3_RESULTS_URL`` AND the caller
