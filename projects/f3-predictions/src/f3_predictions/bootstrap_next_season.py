...
The F1 flagship bootstraps future seasons from FastF1's published schedule; F3
...
is published (add the season's anchor raceid to ``config.FIA_F3_SEASON_ANCHORS``).
...
Usage:
    python -m f3_predictions.bootstrap_next_season                  # active year + 1
    python -m f3_predictions.bootstrap_next_season --year 2027 --force
    python -m f3_predictions.bootstrap_next_season --from-file announced_2027.json
    python -m f3_predictions.bootstrap_next_season --dry-run
"""
