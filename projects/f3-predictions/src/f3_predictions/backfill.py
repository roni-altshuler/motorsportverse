...
Run:  F3_USE_LIVE_RESULTS=1 python -m f3_predictions.backfill --season 2026 [--db <path>]
"""
...
def _rows_for_round(source: F3DataSource, year: int, rnd: int) -> list[HistoryRow]:
