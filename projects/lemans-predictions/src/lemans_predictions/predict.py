"""24 Hours of Le Mans predictor — the shared ``Predictor`` contract.
...
from . import config
from .datasource import LeMansDataSource


class LeMansPredictor(Predictor):
    ...
    def fit(self, source: LeMansDataSource, season: int, upto_round: int) -> None:
    ...
    def predict(self, source: LeMansDataSource, season: int, round: int) -> RoundForecast:
