...
from motorsport_core.leakage import (
    LeakageError,
    assert_prior_only,
...
# NOTE: the F1 project's TestPipelineWiring class (which exercised
# f1_prediction_utils.build_training_dataset) was intentionally dropped here —
# that pipeline is sport-specific and stays in f1-predictions. The leakage
# *guards* themselves are what motorsport-core owns and are covered above.
